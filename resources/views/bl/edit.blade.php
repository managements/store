                        ...
                        <div class="col-md-6 text-left">
                            <div class="text-left">
                                ...
                                <table>
                                    <tr>
                                        <td><h5>Chéque </h5></td>
                                        <td><input type="text" name="payments[0][price]" value="{{ (old('payments.0.price')) ? old('payments.0.price') : $payments[0]['price']}}"
                                                   placeholder="montant" class="btn-spanen">
                                            <input type="text" name="payments[0][operation]" value="{{ (old('payments.0.operation')) ? old('payments.0.operation') : $payments[0]['operation']}}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="payments[1][price]" value="{{ (old('payments.1.price')) ? old('payments.1.price') : $payments[1]['price'] }}"
                                                   placeholder="virement" class="btn-spanen">
                                            <input type="text" name="payments[1][operation]" value="{{ (old('payments.1.operation')) ? old('payments.1.operation') : $payments[1]['operation'] }}"
