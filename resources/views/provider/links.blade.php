        ...
        <div class="page_links">
            <div class="row">
                <div class="col-md-4 offset-2">
                    <a class="brclr-green" href="{{ route('bc.create') }}" > <i class="fas fa-truck-moving"></i> Bon de Commande</a>
                </div>
                <div class="col-md-4">
                    <a class="brclr-blue" href="{{ route('bl.create') }}" > <i class="fas fa-truck-moving"></i> Bon de Livraison</a>
                </div>
            </div>
            <div class="row">
                    <div class="col-md-4 offset-2">
